...
class SharepointService {
  ...
  async listFolderContentsFromPath (path) {
    ...
    await this.sharepoint.authenticate()
    return this.sharepoint.getContents(path)
  }
  ...
  async deleteFile (path, fileName) {
    ...
    await this.sharepoint.authenticate()
    return this.sharepoint.deleteFile({ path, fileName })
  }
  ...
  async moveFile (sourcePath, targetPath, fileName) {
    ...
    await this.sharepoint.authenticate()
    return this.sharepoint.moveFile({ sourcePath, targetPath, fileName })
  }
  ...
  async moveFolderContents (sourcePath, targetPath) {
    ...
    await this.sharepoint.authenticate()
    return this.sharepoint.moveFolderContents({ sourcePath, targetPath })
  }
